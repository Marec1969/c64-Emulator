...
KeyMapping keyMappingsWParam[] = {
    { 0x01, 0x04, 0x02, 0x80, 37 }, // Cursor    
    { 0x01, 0x80, 0x02, 0x80, 38 }, // Cursor    
    { 0x01, 0x04, 0x00, 0x00, 39 }, // Cursor    
    { 0x01, 0x80, 0x00, 0x00, 40 }, // Cursor    
    { 0x80, 0x04, 0x00, 0x00, 27 }, // ESC -> CTRL
};

KeyMapping stickMappingsWParam[] = {
    { 0x10, 0x00, 0x00, 0x00, 17 },
    { 0x08, 0x00, 0x00, 0x00, 34 },
    { 0x04, 0x00, 0x00, 0x00, 46 }, 
    { 0x01, 0x00, 0x00, 0x00, 36 }, 
    { 0x02, 0x00, 0x00, 0x00, 35 },
